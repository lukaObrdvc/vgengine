...
set CompilerFlags=/std:c17 /Zc:preprocessor /TC -DDEBUG=1 -DHOTLOAD=0 -Oi -Zi -MT -GR -EHa -nologo
set LinkerFlags= -incremental:no -opt:ref user32.lib gdi32.lib kernel32.lib winmm.lib
set DLLExports=/EXPORT:update_and_render /EXPORT:platform_init_memory_base /EXPORT:process_frame_input
