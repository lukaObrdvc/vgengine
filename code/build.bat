...
set WarningFlags=-W4 -WX -wd4100 -wd4091 -wd4459 -wd4996 -wd4189 -wd4201 -wd4804 -wd4244 -wd4013 -wd4101 -wd4715 -wd4701 -wd4057 -wd4206 -wd4334 -wd4324
set BaseFlags=-GR -EHa -nologo /std:c++20
set LinkerFlags=-incremental:no -opt:ref
set Imports=user32.lib gdi32.lib kernel32.lib winmm.lib
set Exports=/EXPORT:update_and_render /EXPORT:platform_init_engine /EXPORT:platform_init_memory_base /EXPORT:shut_down_all_threads /EXPORT:start_up_all_threads
