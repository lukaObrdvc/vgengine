...
void final_giga_test(void)
{
    ...
    v3 s_vertices[8] = {
        V3(-10, -10, -150) , V3(-10, 10, -150) ,
        V3(10, 10, -150)   , V3(10, -10, -150) ,
        V3(-10, -10, -170) , V3(-10, 10, -170) ,
        V3(10, 10, -170)   , V3(10, -10, -170)
    };
    u16 s_indices[36] = {
    ...
    for (int i = 0; i < 8; i++)
        {
            s_vertices[i] = M4Mul(s_vertices[i], cameraMatrix);
        }
    ...
    for (int i = 0; i < ArrCount(s_indices)/3; i++)
        {
            ...
            v3 A = cube.vertices[i0];
            v3 B = cube.vertices[i1];
            v3 C = cube.vertices[i2];
            ...
            for (int k = 0; k < count; k++)
                {
                    ...
                    if (Gamestate->reverse_winding)
                        ...
                        {
                            RasterizeTriangle(tri.A, tri.C, tri.B, color, false);
                        }
                }
            b += 3;
        }
...
void projection_matrix_test(void)
{
